...
class Tabakalera {
	...
	public function extractDataEvents($language) {
		...
		while (true) {
			...
			$url['es'] = 'https://www.tabakalera.eu/es/agenda-cultural-san-sebastian/mensual?page=' . $page;
			$url['eu'] = 'https://www.tabakalera.eu/eu/agenda-kulturala-donostia/hilabetea?page=' . $page;
			$url = $url[$language];
